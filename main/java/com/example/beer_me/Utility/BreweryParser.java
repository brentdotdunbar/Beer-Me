...
import com.example.beer_me.Network.model.BreweryResponse;
...
public class BreweryParser {
     ...
     * @return list of beers (as BreweryModels)
     */

    public static List<BreweryModel> getMatches(String json)
    {
        //creates new gson model
        Gson gson = new Gson();

        //Deserialize json into BreweryResponsemodel using gson
        BreweryResponse BreweryResponseAppModel = gson.fromJson(json, BreweryResponse.class);

        //get the list of beer models and return it
        return BreweryResponseAppModel.getBreweries();
    }
